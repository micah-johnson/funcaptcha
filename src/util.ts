...
function getBda(userAgent: string, pkey: string, surl: string, referer?: string, location?: string, canvasFp?: string, randomCanvasFp?: boolean): string {
    let fp = fingerprint.getFingerprint(canvasFp, randomCanvasFp);
