...
class Session {
    ...
    getEmbedUrl() {
        ...
        if (this.tokenRaw) {
            gameVersion = (_b = (_a = this.tokenRaw.challenge_url_cdn.match(/ec-game-core\/bootstrap\/(.*)\/standard/)) === null || _a === void 0 ? void 0 : _a[1]) !== null && _b !== void 0 ? _b : gameVersion;
        }
        ...
        return `${this.tokenInfo.surl}/fc/assets/ec-game-core/game-core/${gameVersion}/standard/index.html?${util_1.default.constructFormData(newQuery)}`;
    }
}
